...
urlpatterns = [
    ...
    path('<int:user_id>/<int:semester_id>/<date:start>/sub/view/', views.SubjectView.as_view(), name='sub_view'),
    path('<int:user_id>/<int:semester_id>/<date:start>/sub/update/', views.SubjectUpdate.as_view(), name='sub_update'),
    ...
    path('<int:user_id>/<int:semester_id>/<date:start>/home/view/', views.HomeroomView.as_view(), name='home_view'),
