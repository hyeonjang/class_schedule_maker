...
urlpatterns = [
    ...
    path('<int:user_id>/sub/reset/', views.SubjectReset.as_view(), name='sub_reset'),
    ...
    path('<int:user_id>/home/reset/', views.HomeroomReset.as_view(), name='home_reset'),
    ...
    path('<int:user_id>/sub/reset/', views.InvitedReset.as_view(), name='inv_reset'),
